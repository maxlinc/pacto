...
describe Pacto::InvestigationRegistry do
  ...
  describe '.failed_investigations' do
    ...
    it 'returns investigations with unsuccessful citations' do
      ...
      expect(investigation_with_successful_citations).to receive(:successful?).at_least(1).times.and_return true
      expect(investigation_with_unsuccessful_citations).to receive(:successful?).at_least(1).times.and_return false
